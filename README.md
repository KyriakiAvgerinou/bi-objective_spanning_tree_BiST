...
Here's an example of an initial connected, undirected graph _G_ (where each edge holds a profit and a cost _(p(e), c(e))_) and its optimal MSTs _T_ that maximize the total profit to total cost ratio:<br />
